...
{
	m_ShipTexture = Vortex::Texture2D::Create("/home/pc/dev/engine/Sandbox/assets/Textures/Ship.png");
}

void Player::OnUpdate(Vortex::TimeStep ts)
{
    m_Time += ts;

	if (Vortex::Input::IsKeyPressed(Vortex::Key::Space))
	{
...
void Player::OnRender()
{
	...
	Vortex::Renderer2DGame::DrawQuad({ m_Position.x, m_Position.y, 0.5f }, { 1.0f, 1.3f }, glm::radians(GetRotation()), m_ShipTexture);
}

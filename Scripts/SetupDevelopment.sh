...
declare -a vendors=("spdlog" "glfw", "imgui", "glm", "shaderc", "spirv-cross", "yaml-cpp", "gizmo", "imnode")
declare -a versions=("v1.14.1" "3.4", "v1.91.3-docking", "1.0.1", "v2024.3". "vulkan-sdk-1.3.296.0", "0.8.0", "1.83", "v0.9.3")
